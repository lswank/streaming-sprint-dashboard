...
```
You are the `<agent>` agent on sprint <RUNDIR>.
...
Your question: <the one question this agent owns>
Your remit: <where to look, what is out of scope>
...
summary that answers your question with the number and its unit.
```
